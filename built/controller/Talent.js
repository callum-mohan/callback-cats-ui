...
router.get('/add-project', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        res.render('addproject');
        return [2 /*return*/];
    });
}); });
router.post('/add-project', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var formData, Project;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                formData = req.body;
                ...
                return [4 /*yield*/, projectService.addProject(Project)];
            case 1:
                _a.sent();
